    ...
    <body>
        ...
        <div class="contact-area ptb-100">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 p-20 box-shadow-light">
                        <div class="contact-wrap form-style">
                            ...
                            <form  method="post" id="cf">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <button type="submit" class="cont-submit btn-contact btn-style" onclick="return valid()" name="sub_btn" id="sub_btn">Sign Up</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <script>
            ...
            if (pnumb === '' || !phoneRegex.test(pnumb)) {
                markInvalid('#phone', 'Please enter a valid phone number (e.g., 312-1234567, 0312-1234567, +92312-1234567, or 03121234567).');
            }
