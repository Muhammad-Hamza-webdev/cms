            ...
            <div class="row">
                <div class="col-md-6 col-sm-8 col-xs-12">
                    <div class="header-top-left">
                        <p>We are here for you, to gain your confidence</p>
                    </div>
                </div>
    ...
    <div class="header-bottom" id="sticky-header">
        <div class="container">
            <div class="row">
                                ...
                                <g transform="translate(3.5 3.5)" data-name="Component 15 – 1" id="Component_15_1">
                                    ...
                                    <g transform="translate(2.333 2.333)" id="button">
                                        ...
                                        <g data-name="sun" id="sun">
                                            ...
                                            <circle fill="#fcf4b9" transform="translate(8.167 8.167)" r="7" cy="7"
                                                cx="7" id="sun-inner"></circle>
                                        </g>
                ...
                <div class="col-sm-2 clear col-xs-3 hidden-md hidden-lg " style="position: absolute; right: 0;">
