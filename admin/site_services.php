                            ...
                            <div class="card-body">
                                <form id="validationform" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">New Service
                                            Name</label>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Service
                                            description</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <textarea class="form-control" required="" name="s_desc"
                                                id="s_desc"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
