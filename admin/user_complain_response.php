...
<head>
    ...
    <title>Complain Detail | Complain Managment System Hajvery University</title>
    <!-- favicon -->
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a class="breadcrumb-link">View All
                                                        Complains</a></li>
                                                <li class="breadcrumb-item active" aria-current="page"> Complain
                                                    Response</li>
                                            </ol>
                                        </nav>
                                    </div>
                                ...
                                <div class="card" id="align">
                                    ...
                                    <div class="card-body border-top">
                                        <h3 class="text-center">
                                            <h3 class="text-center" style="text-decoration: underline;">Response From
                                                Admin</h3>
                                            ...
                                            <?php
                                                        if ($row2['file'] != '') {
                                                            ?>
                                            <h3 class="text-left">File: <a href="<?= $row2['file'] ?>"><i
                                                        class="fas fa-download"></i></a></h3>
                                            <?php
                                                        }
                                                        ?>
                                        </h3>
                                    ...
                                    <div class="card-body border-top">
                                        <h3 class="text-center">
                                            ...
                                            <button type="button" class="btn btn-outline-info btn-lg"
                                                data-toggle="modal" data-target="#myModal2">See Feedback</button>
                                            <?php
                                                        } else {
                                                            ?>
                                            <button type="button" class="btn btn-info btn-lg" data-toggle="modal"
                                                data-target="#myModal">Give FeedBack</button>
                                            <?php
                                                        }
                                                        ?>
                                        ...
                                        <div class="modal-dialog">
                                            <form method="post">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-default" name="btn_send"
                                                            onclick="return valid()">Send</button>
                                                    </div>
                                            </form>
                                        </div>
