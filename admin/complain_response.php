...
<head>
    ...
    <title>Complain response | Complain Managment System Hajvery University</title>
    <!-- favicon -->
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a class="breadcrumb-link">Manage
                                                        Complains</a></li>
                                                <li class="breadcrumb-item active" aria-current="page">Panding Complains
                                                </li>
                                                <li class="breadcrumb-item active" aria-current="page">Complain Detail
                                                </li>
                                            </ol>
                                        </nav>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card" id="align">
                                    <h5 class="card-header">Applicant Name:
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form id="validationform" data-parsley-validate="" method="post" novalidate=""
                                            enctype="multipart/form-data">
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Upload
                                                    Response File(Not Nesessary)</label>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Response
                                                    Description</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <textarea required="" name="desc" id="desc"
                                                        class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row text-right">
                                                <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                    <button class="btn btn-space btn-secondary" name="sub_response"
                                                        id="sub_response" type="submit">Submit</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
