...
<head>
    ...
    <title>Register Complian | Complain Managment System Hajvery University</title>
    <!-- favicon -->
...
<body>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a class="breadcrumb-link">Register New Complain</a>
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="validationform" method="post">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Complan
                                            Description</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                    ...
                                    <div class="form-group row text-right">
                                        <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                            <button type="submit" name="send_btn" onclick="return valid()"
    ...
    function valid() {
        ...
        if (desc.trim() == '') {
            ...
            toastr.error('Complain description cannot be empty!');
