                            ...
                            <div class="page-header">
                                <?php
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            ?>
                                <h2 class="pageheader-title">Welcome :
                                    <?= $row['person_name'] . " " . $row['last_name'] ?></h2>
                                <?php
                                        }
                                        ?>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="badge-dot badge-danger mr-1"></span>Pending
                                                        </td>
                                                        <td>
                                                            <input type="button" class="btn btn-info"
                                                                value="View Detail"
                                                                onclick="return view_detail_complain(<?= $row['complaint_id'] ?>)" />
                                                        </td>
                                                    </tr>
                                                    <?php
                                                                    $sr++;
                                                    ...
                                                    <?php
                                                        ...
                                                        ?>
                                                    <tr>
                                                        <td colspan="9"><a href="all_complians.php"
                                                                class="btn btn-outline-light float-right">View All
                                                                Complains</a></td>
                                                    </tr>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="button"
                                                                <?= ($row['com_status'] == 3) ? 'class="btn btn-success" value="View Response"' : 'disabled="" class="btn btn-danger" value="Waiting" ' ?>
                                                    ...
                                                    <?php
                                                        ...
                                                        ?>
                                                    <tr>
                                                        <td colspan="6"><a href="user_all_complians.php"
                                                                class="btn btn-outline-light float-right">View All
                                                                Details</a></td>
                                                    </tr>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                        ...
                                                        ?>
                                                    <tr>
                                                        <td colspan="6"><a href="all_complians.php"
                                                                class="btn btn-outline-light float-right">View All
                                                                Complains</a></td>
                                                    </tr>
