                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xs-12 col-md-8 col-md-offset-2">
                                            ...
                                            <p>CMS is a program that allows students  problems deliver consistent support and manage complaints in a timely manner.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xs-12 col-md-8 col-md-offset-2">
                                            ...
                                            <p>For an effective educational system to take place there are some issues in academic environment that should properly address to, take for instance issue of complaints management system in the university.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12 wow fadeInLeft">
                        ...
                        <div class="about-img mission-img h-250">
                            <img src="assets/images/Home-Mission.webp" alt="Home Mission" />
                        </div>
                    </div>
                    <div class="col-md-6 col-xs-12 wow fadeInRight">
                        <div class="about-wrap">
                            <h3>Our mission is to give everyone a voice and show them the world.</h3>
                            <p>Students complaint is the best indicator to determine whether a service-oriented university operates well. If a university does not handle its students complaint properly and promptly, further negative students responses will cause major damage to the reputation of the university. </p>
                            <p>Traditionally, written complaints cause communication gap and information asymmetry. Thus, some trouble cases may not be handled properly without real-time decision supports by the higher authority.</p>
                            <ul>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in">
                                        <div class="panel-body">
                                            <p>Welcome to the Complain Managment System Help Desk. The Help Desk is here to answer your questions about the CMS(Complain Managment System). Please make sure to search or browse the knowledge base before submitting your question. The answer you are looking for may already be there. Thank you.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseTwo" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <p>To promote Higher Education system that may keep pace with developments and changes in today world, meet the requirements of sustainable development in the Knowledge Era, while preserving the cultural identity of our society and contribute to the progress and development of humankind by raising the quality of institutions of higher education in Punjab.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapsesix" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <p>We provide holistic quality higher education to all the citizens in an effective, efficient, and supportive environment to facilitate them in the achievement of their goals and objectives.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="faq-form form-style">
                            ...
                            <form action="mail.php" method="post" id="cf">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <button id="msg_btn" class="cont-submit btn-contact btn-style" onclick="return valid()" name="msg_btn">Questions</button>
                                    </div>
                                </div>
                            </form>
                        </div>
